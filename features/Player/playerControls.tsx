    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-4 lg:gap-5">
          ...
          >
            <Shuffle className="h-3.75 w-3.75g:h-4 lg:w-4" />
            {isShuffle && (
              <span className="absolute -bottom-1 left-1/2 h-0.75 w-0.75 -translate-x-1/2 rounded-full bg-purple-500" />
            )}
          </button>
          ...
          >
            {repeatMode === "one" ? (
              <Repeat1 className="h-3.75 w-3.75 lg:h-4 lg:w-4" />
            ) : (
              <Repeat className="h-3.75 w-3.75 lg:h-4 lg:w-4" />
            )}
            {repeatMode !== "off" && (
              <span className="absolute -bottom-1 left-1/2 h-0.75 w-0.75 -translate-x-1/2 rounded-full bg-purple-400" />
            )}
          </button>
        </div>
...
export function ProgressBar({
  ...
  return (
    <div
      className={`flex w-full items-center ${compact ? "gap-2" : "gap-2 lg:gap-2.5"}`}
    >
